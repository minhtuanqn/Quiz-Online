 ...
 * @author MINH TUAN
 */
@WebServlet(name = "OnloadStudentServlet", urlPatterns = {"/OnloadStudentServlet"})
public class OnloadStudentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("OnloadStudentServlet_Naming: " + ex.getMessage());
        } 
        catch (SQLException ex) {
            log("OnloadStudentServlet_SQL: " + ex.getMessage());
        }        
        finally {
