 ...
 * @author MINH TUAN
 */
public class QuizQuestionPagingModel {
    public final static int NUMRECORDOFEACHPAGE = 1;
    private int totalPage = 1;
    private List<List> pagingList;

    public int getNUMRECORDOFEACHPAGE() {
        return NUMRECORDOFEACHPAGE;
    }
    
    public int getTotalPage(List<List> mapQuesAndAnsList) {
    ...
    public List<List> loadPaging(List<List> quesAndAnsMapList, int curPage) {
